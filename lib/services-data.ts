...
const services: ServiceData[] = [
  // ── 1. AI & Automatisering ──────────────────
  {
    ...
    emoji: '🤖',
    meta: {
      title: 'AI & Automatisering | Chatbots og AI-agenter | attentio',
      description:
        'Vi bygger skreddersydde AI-chatbots og agenter som svarer kunder, kvalifiserer leads og automatiserer prosesser – 24/7. Bergen-basert AI-byrå.',
    },
    hero: {
      tag: 'AI & Automatisering',
      h1: 'En AI-assistent som jobber for deg – <em>alltid</em>',
      intro:
        'Tenk deg en medarbeider som aldri sover, aldri tar ferie og svarer kunder på sekunder – på nettside, Instagram og WhatsApp. Det er akkurat det vi bygger for deg.',
    },
    features: {
      tag: 'Hva vi leverer',
    ...
    process: {
      ...
      title: 'Fra idé til aktiv AI-assistent – <em>på rekordtid</em>',
      steps: [
        {
          num: '01',
          title: 'Workshop & datainnsamling',
          text: 'Vi kartlegger dine vanligste kundehenvendelser, samler treningsdata og definerer hvilke oppgaver AI-en skal håndtere.',
          chip: 'Gratis innledende møte',
        },
        {
          num: '02',
          title: 'Bygging & trening',
          text: 'AI-agenten bygges, trenes på dine data og testes grundig for å sikre presise og merkevareriktige svar.',
          chip: '2–4 uker',
        },
        {
          num: '03',
          title: 'Integrasjon & kanaler',
          text: 'Vi kobler AI-en til dine systemer og kommunikasjonskanaler. Alt testes i produksjonsmiljø før lansering.',
          chip: '1–2 uker',
        },
        {
          num: '04',
          title: 'Lansering & videreutvikling',
          text: 'Etter lansering overvåker vi ytelse, tilpasser basert på faktisk bruk og videreutvikler boten løpende.',
    ...
    benefits: {
      ...
      items: [
        ...
        },
        {
          ...
          text: 'Full tilgjengelighet utenfor arbeidstid – uten overtid, vikarer eller nattevakter. AI-en er alltid klar.',
        },
        {
          icon: '📈',
        ...
        },
        {
          ...
          text: 'Håndter 1 eller 10 000 samtaler simultant uten ekstra kostnad. AI-en skalerer automatisk med veksten din.',
        },
      ],
    },
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: 'Ja, vi trener alltid boten primært på norsk. Vi kan støtte alle språk og kan bygge flersprå klige løsninger for bedrifter som opererer internasjonalt.',
        },
        {
