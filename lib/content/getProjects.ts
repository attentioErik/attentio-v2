...
export async function getProjects(): Promise<Project[]> {
  try {
    ...
    console.error('[Sanity] Failed to fetch projects:', e)
  }
  return projectsData
}
...
export async function getProject(slug: string): Promise<Project | undefined> {
  try {
    ...
    console.error('[Sanity] Failed to fetch project:', slug, e)
  }
...
export async function getAllProjectSlugs(): Promise<string[]> {
  try {
    ...
    console.error('[Sanity] Failed to fetch project slugs:', e)
  }
